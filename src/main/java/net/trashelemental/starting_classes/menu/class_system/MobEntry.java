...
public record MobEntry(ResourceLocation entityId, int count, @Nullable String nbtString) implements EquipmentEntry {
    ...
    public static final Codec<MobEntry> CODEC =
            RecordCodecBuilder.create(instance -> instance.group(
                    ResourceLocation.CODEC.fieldOf("entityId").forGetter(MobEntry::entityId),
                    Codec.INT.optionalFieldOf("count", 1).forGetter(MobEntry::count),
